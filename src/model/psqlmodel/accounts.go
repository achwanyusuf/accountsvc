...
var (
	accountAllColumns            = []string{"id", "email", "password", "name", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at"}
	accountColumnsWithoutDefault = []string{"email", "password", "name"}
	accountColumnsWithDefault    = []string{"id", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at"}
...
func (q accountQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Account, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "psqlmodel: failed to execute a one query for accounts")
	}
...
func (q accountQuery) All(ctx context.Context, exec boil.ContextExecutor) (AccountSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "psqlmodel: failed to assign all query results to Account slice")
	}
...
func (q accountQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to count accounts rows")
	}
...
func (q accountQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "psqlmodel: failed to check if accounts exists")
	}
...
func FindAccount(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Account, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "psqlmodel: unable to select from accounts")
	}
...
func (o *Account) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("psqlmodel: no accounts provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "psqlmodel: unable to insert into accounts")
	}
...
func (o *Account) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("psqlmodel: unable to update accounts, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to update accounts row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to get rows affected by update for accounts")
	}
...
func (q accountQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to update all for accounts")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to retrieve rows affected for accounts")
	}
...
func (o AccountSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to update all in account slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to retrieve rows affected all in update all account")
	}
	return rowsAff, nil
}
...
func (o *Account) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("psqlmodel: no accounts provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("psqlmodel: unable to upsert accounts, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(accountPrimaryKeyColumns) == 0 {
				return errors.New("psqlmodel: unable to upsert accounts, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "psqlmodel: unable to upsert accounts")
	}
...
func (o *Account) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if o == nil {
		return 0, errors.New("psqlmodel: no Account provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to delete from accounts")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to get rows affected by delete for accounts")
	}
...
func (q accountQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("psqlmodel: no accountQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to delete all from accounts")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to get rows affected by deleteall for accounts")
	}
...
func (o AccountSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to delete all from account slice")
	}
...
func (o *Account) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("psqlmodel: no Account provided for reload")
	}
...
func (o *AccountSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("psqlmodel: empty AccountSlice provided for reload all")
	}
...
func (o *AccountSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "psqlmodel: unable to reload all in AccountSlice")
	}
...
func AccountExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "psqlmodel: unable to check if accounts exists")
	}
