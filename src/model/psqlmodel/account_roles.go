...
func (q accountRoleQuery) One(ctx context.Context, exec boil.ContextExecutor) (*AccountRole, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "psqlmodel: failed to execute a one query for account_roles")
	}
...
func (q accountRoleQuery) All(ctx context.Context, exec boil.ContextExecutor) (AccountRoleSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "psqlmodel: failed to assign all query results to AccountRole slice")
	}
...
func (q accountRoleQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to count account_roles rows")
	}
...
func (q accountRoleQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "psqlmodel: failed to check if account_roles exists")
	}
...
func FindAccountRole(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*AccountRole, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "psqlmodel: unable to select from account_roles")
	}
...
func (o *AccountRole) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("psqlmodel: no account_roles provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "psqlmodel: unable to insert into account_roles")
	}
...
func (o *AccountRole) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("psqlmodel: unable to update account_roles, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to update account_roles row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to get rows affected by update for account_roles")
	}
...
func (q accountRoleQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to update all for account_roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to retrieve rows affected for account_roles")
	}
...
func (o AccountRoleSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to update all in accountRole slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to retrieve rows affected all in update all accountRole")
	}
	return rowsAff, nil
}
...
func (o *AccountRole) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("psqlmodel: no account_roles provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("psqlmodel: unable to upsert account_roles, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(accountRolePrimaryKeyColumns) == 0 {
				return errors.New("psqlmodel: unable to upsert account_roles, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "psqlmodel: unable to upsert account_roles")
	}
...
func (o *AccountRole) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if o == nil {
		return 0, errors.New("psqlmodel: no AccountRole provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to delete from account_roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to get rows affected by delete for account_roles")
	}
...
func (q accountRoleQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("psqlmodel: no accountRoleQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to delete all from account_roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to get rows affected by deleteall for account_roles")
	}
...
func (o AccountRoleSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to delete all from accountRole slice")
	}
...
func (o *AccountRole) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("psqlmodel: no AccountRole provided for reload")
	}
...
func (o *AccountRoleSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("psqlmodel: empty AccountRoleSlice provided for reload all")
	}
...
func (o *AccountRoleSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "psqlmodel: unable to reload all in AccountRoleSlice")
	}
...
func AccountRoleExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "psqlmodel: unable to check if account_roles exists")
	}
