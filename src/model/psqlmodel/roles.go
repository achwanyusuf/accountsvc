...
type Role struct {
	...
	Sec       string    `boil:"sec" json:"sec" toml:"sec" yaml:"sec"`
...
var RoleTableColumns = struct {
	...
	UpdatedBy: "roles.updated_by",
	UpdatedAt: "roles.updated_at",
	DeletedBy: "roles.deleted_by",
...
var RoleWhere = struct {
	...
	Scope:     whereHelperstring{field: "\"roles\".\"scope\""},
	Cid:       whereHelperstring{field: "\"roles\".\"cid\""},
	Sec:       whereHelperstring{field: "\"roles\".\"sec\""},
	CreatedBy: whereHelperint{field: "\"roles\".\"created_by\""},
	CreatedAt: whereHelpertime_Time{field: "\"roles\".\"created_at\""},
	UpdatedBy: whereHelperint{field: "\"roles\".\"updated_by\""},
	UpdatedAt: whereHelpertime_Time{field: "\"roles\".\"updated_at\""},
	DeletedBy: whereHelpernull_Int{field: "\"roles\".\"deleted_by\""},
...
func (r *roleR) GetAccountRoles() AccountRoleSlice {
	if r == nil {
		return nil
	}
...
var (
	roleAllColumns            = []string{"id", "scope", "cid", "sec", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at"}
	roleColumnsWithoutDefault = []string{"scope", "cid", "sec"}
	roleColumnsWithDefault    = []string{"id", "created_by", "created_at", "updated_by", "updated_at", "deleted_by", "deleted_at"}
...
func (q roleQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Role, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "psqlmodel: failed to execute a one query for roles")
	}
...
func (q roleQuery) All(ctx context.Context, exec boil.ContextExecutor) (RoleSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "psqlmodel: failed to assign all query results to Role slice")
	}
...
func (q roleQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to count roles rows")
	}
...
func (q roleQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "psqlmodel: failed to check if roles exists")
	}
...
func (o *Role) AccountRoles(mods ...qm.QueryMod) accountRoleQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"account_roles\".\"role_id\"=?", o.ID),
	)
...
func (roleL) LoadAccountRoles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
	...
	query := NewQuery(
		...
		qm.WhereIn(`account_roles.role_id in ?`, argsSlice...),
...
func (o *Role) AddAccountRolesG(ctx context.Context, insert bool, related ...*AccountRole) error {
...
// Appends related to o.R.AccountRoles.
// Sets related.R.Role appropriately.
func (o *Role) AddAccountRoles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*AccountRole) error {
	var err error
...
func FindRoleG(ctx context.Context, iD int, selectCols ...string) (*Role, error) {
...
func FindRole(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Role, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "psqlmodel: unable to select from roles")
	}
...
func (o *Role) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("psqlmodel: no roles provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "psqlmodel: unable to insert into roles")
	}
...
func (o *Role) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("psqlmodel: unable to update roles, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to update roles row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to get rows affected by update for roles")
	}
...
func (q roleQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to update all for roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to retrieve rows affected for roles")
	}
...
func (o RoleSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to update all in role slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to retrieve rows affected all in update all role")
	}
	return rowsAff, nil
}
...
func (o *Role) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("psqlmodel: no roles provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("psqlmodel: unable to upsert roles, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(rolePrimaryKeyColumns) == 0 {
				return errors.New("psqlmodel: unable to upsert roles, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "psqlmodel: unable to upsert roles")
	}
...
func (o *Role) DeleteG(ctx context.Context, hardDelete bool) (int64, error) {
...
func (o *Role) Delete(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if o == nil {
		return 0, errors.New("psqlmodel: no Role provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to delete from roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to get rows affected by delete for roles")
	}
...
func (q roleQuery) DeleteAllG(ctx context.Context, hardDelete bool) (int64, error) {
...
func (q roleQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("psqlmodel: no roleQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to delete all from roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: failed to get rows affected by deleteall for roles")
	}
...
func (o RoleSlice) DeleteAllG(ctx context.Context, hardDelete bool) (int64, error) {
...
func (o RoleSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor, hardDelete bool) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "psqlmodel: unable to delete all from role slice")
	}
...
func (o *Role) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("psqlmodel: no Role provided for reload")
	}
...
func (o *RoleSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("psqlmodel: empty RoleSlice provided for reload all")
	}
...
func (o *RoleSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "psqlmodel: unable to reload all in RoleSlice")
	}
...
func RoleExistsG(ctx context.Context, iD int) (bool, error) {
...
func RoleExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "psqlmodel: unable to check if roles exists")
	}
